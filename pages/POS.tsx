...
import { Invoice, InvoiceStatus, PaymentMethodType, PaymentRecord, InvoiceItem } from '../types';
            ...
            <div className="flex-1 bg-white rounded-2xl shadow-soft flex flex-col overflow-hidden relative">
                {activeInvoice ? (
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center text-text-muted">
                        ...
                        <p>Select an invoice from the queue to process payment.</p>
                    </div>
                )}
            </div>
        </div>
